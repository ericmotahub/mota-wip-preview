        ...
        <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input required type="text" className="w-full bg-white/5 border border-white/10 rounded-lg px-5 py-4 focus:outline-none focus:border-brand-pink transition-colors" />
            </div>
            <div>
              <label className="block text-[10px] uppercase tracking-widest text-gray-500 font-bold mb-2">Email Address</label>
              <input required type="email" className="w-full bg-white/5 border border-white/10 rounded-lg px-5 py-4 focus:outline-none focus:border-brand-pink transition-colors" />
            </div>
          </div>
          
          <div>
            <label className="block text-[10px] uppercase tracking-widest text-gray-500 font-bold mb-2">Your Professional Vertical</label>
            <select className="w-full bg-[#222] border border-white/10 rounded-lg px-5 py-4 focus:outline-none focus:border-brand-pink transition-colors appearance-none cursor-pointer">
          ...
          <div>
            ...
            <textarea required rows={5} className="w-full bg-white/5 border border-white/10 rounded-lg px-5 py-4 focus:outline-none focus:border-brand-pink transition-colors resize-none"></textarea>
          </div>
      ...
      <div className="max-w-md w-full bg-white/5 border border-white/10 p-10 rounded-xl">
        ...
        <form className="space-y-6">
          <div>
            ...
            <input type="email" placeholder="client@studio.com" className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-sm focus:outline-none focus:border-brand-pink" />
          </div>
          <div>
            <label className="block text-[10px] uppercase tracking-widest text-gray-400 font-bold mb-2">Access Key</label>
            <input type="password" placeholder="••••••••" className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-sm focus:outline-none focus:border-brand-pink" />
          </div>
...
const App: React.FC = () => {
  ...
  const getSubtitle = () => {
    switch (currentView) {
      ...
      case ViewType.PARTNERS: return 'PARTNERS';
          ...
          <>
            ...
            <section className="relative z-10 min-h-screen flex flex-col justify-center items-center text-center px-6 pt-40 pb-20">
              <div className="max-w-7xl mx-auto w-full">
                <h1 className="text-5xl sm:text-8xl md:text-[110px] font-['Oswald'] leading-none tracking-tight mb-8">
                  The Solution Engine
            ...
            <section id="network-summary" className="relative z-10 py-32 bg-white/[0.02] border-y border-white/5">
              <div className="max-w-5xl mx-auto px-6 text-center">
                <h2 className="text-4xl md:text-5xl font-['Oswald'] mb-8">Building confidence in a complex industry.</h2>
                <p className="text-lg text-text-body mb-12 max-w-4xl mx-auto leading-relaxed">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <div className="bg-white/5 border border-white/10 px-8 py-10 rounded-lg flex flex-col items-center w-full sm:w-[280px]">
                    <span className="text-4xl text-brand-pink font-['Oswald'] mb-2">250+</span>
                    <span className="text-[10px] uppercase tracking-widest text-gray-500 font-bold">Vetted Studios</span>
                  </div>
                  <div className="bg-white/5 border border-white/10 px-8 py-10 rounded-lg flex flex-col items-center w-full sm:w-[280px]">
                    <span className="text-4xl text-brand-pink font-['Oswald'] mb-2">15</span>
                    <span className="text-[10px] uppercase tracking-widest text-gray-500 font-bold">Global Hubs</span>
                  </div>
                  <div className="bg-white/5 border border-white/10 px-8 py-10 rounded-lg flex flex-col items-center w-full sm:w-[280px]">
                    <span className="text-4xl text-brand-pink font-['Oswald'] mb-2">∞</span>
                    <span className="text-[10px] uppercase tracking-widest text-gray-500 font-bold">Solution Logic</span>
                  </div>
                </div>
              </div>
            </section>
      ...
      <footer className="relative z-10 py-16 text-center border-t border-white/5 bg-brand-dark">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-[11px] text-gray-600 uppercase tracking-[4px] font-semibold">
            © 2026 Mota Global. Empowering Visual Excellence.
          </p>
